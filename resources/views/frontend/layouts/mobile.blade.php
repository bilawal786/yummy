...
<div class="header-area" id="headerArea">
    ...
    @if(Route::current()->getName() == 'home' or Route::current()->getName() == 'search')
        <!-- Logo Wrapper-->
            <div class="logo-wrapper"><a href="{{route('home')}}"><img src="{{ asset('Yummy-box-picto.png') }}" alt=""
                                                                       style="width: 40px;"></a></div>
            <!-- Search Form-->
            <div class="top-search-form">
                <form action="{{route('search')}}" method="GET">
                    <input class="form-control" type="search" name="name" value="{{request()->query('name')}}"
    ...
    <div class="suha-sidenav-wrapper" id="sidenavWrapper">
        ...
        <div class="sidenav-profile">
            <div class="user-info">
                ...
                <p class="available-balance"><span><span class="counter"> {{ $user->balance->balance }}</span> {{ __('YummyCoin') }}</span>
                </p>
            </div>
        </div>
        <!-- Sidenav Nav-->
        <ul class="sidenav-nav ps-0">
            @if($user->myrole == 1 || $user->myrole == 3 || $user->myrole == 5)
                <li><a href="{{ route('admin') }}"><i class="lni lni-briefcase"></i>Accès boutique </a></li> @endif
            ...
            <li><a href="{{ route('yummycoin') }}"><i class="lni lni-wallet lni-tada-effect"></i>Recharger mon
                    compte</a></li>
            ...
            <li><a href="{{ route('logout') }}"
                   onclick="event.preventDefault();document.getElementById('logout-form-sidebar').submit();"><i
                            class="lni lni-power-switch"></i>Déconnexion</a>

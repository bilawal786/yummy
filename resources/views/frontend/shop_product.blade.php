                        ...
                        <main class="col-sm-6">
                            <article class="content-body">
                                ...
                                <div class="row mt-3 align-items-center">
                                    <div class="col">
                                        <span class="price h4" id="productPrice" data-unit-price="{{ $shopProduct->unit_price - $shopProduct->discount_price }}" data-currency-code="{{ setting('currency_code') }}">{{ $shopProduct->unit_price - $shopProduct->discount_price }}{{ setting('currency_code') }}</span>
                                    </div> <!-- col.// -->

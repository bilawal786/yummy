        ...
        <div class="flash-sale-slide owl-carousel">
          ...
          <div class="card flash-sale-card">
            <div class="card-body">
              ...
              @endif
              <a href="{{ route('shop.product.details', ['shop'=>$shop->slug,'product'=>$product->product->slug]) }}"><img src="{{ $product->product->images }}"><span class="product-title">{{ $product->product->name }}</span>
                @if($product->quantity != 0)

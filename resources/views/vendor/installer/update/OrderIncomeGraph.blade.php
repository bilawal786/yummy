    ...
    $(function() {
        ...
        function LoadEarningMonthly() {
            ...
            $('#earningGraph').highcharts({
                ...
                title: {
                    text: '<?=date('Y')?> Résumé des revenus et des commandes'
                },
                subtitle: {
                    text: 'Afficher le graphique des revenus mensuels et des commandes.'
                },
                xAxis: {
        ...
        function LoadDayWiseExpenseOrIncome(type, monthID, monthName, dayWiseData) {
          'use strict';
            ...
            if(type === 'income') {
                ...
                tooltipTitle = 'Revenu';
                sidebarTitle = 'Montant';
            } else {
                color        = 'rgb(216,27,96)';
                tooltipTitle = 'Commande';
                sidebarTitle = 'Commande';
            }

            $.ajax({
                type: 'POST',
                url: "<?=route('admin.dashboard.day-wise-income-order')?>",

                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.shop.products.update', [$shop, $shopproduct]) }}" method="POST">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="product_id" name="product_id" class="form-control @error('product_id') is-invalid @enderror">
                                        <option value="">{{ __('Choisir un produit') }}</option>
                                        @if(!blank($products))
                        ...
                        <div class="row" id="single-product">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="unit_price">{{ __('Prix Normal') }}</label> <span
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="quantity">{{ __('Quantité') }}</label> <span
                                        class="text-danger">*</span>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="discount_price">{{ __('Prix Yummy') }}</label> <span
                                        class="text-danger">*</span>

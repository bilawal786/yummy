                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="article-header">
                                <h5>{{ __('Ma boutique') }}</h5>
                            </div>
                            <div class="form-row">
                                <div class="form-group col" style="display:none">
                                    <label for="location">Ville</label> <span
                                    ...
                                    <select name="location_id" id="location"
                                        ...
                                        <option value="">{{ __('Choisir la ville') }}</option>
                                        @if(!blank($locations))
                            ...
                            <div class="form-row" @if(auth()->user()->myrole != 1) style="display:none;" @endif >
                                <div class="form-group col">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input name="logo" type="file"
                                        class="custom-file-input @error('logo') is-invalid @enderror" id="customFile"

...
@section('main-content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('Produit de la boutique') }}</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6" id="product-variation">
                                <div class="form-group">
                                    ...
                                    <select id="product_type" name="product_type" class="form-control @error('product_type') is-invalid @enderror">
                                        ...
                                        <option {{ old('product_type')=="5"? 'selected':''}} selected value="5">{{ __('Single') }}</option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="product_id">{{ __('Produits') }}</label> <span class="text-danger">*</span>
                                    <select id="product_id" name="product_id" class="select2 form-control @error('product_id') is-invalid @enderror">
                                        <option data-productmrp="0" value="">{{ __('Choisir un produit') }}</option>
                                        @if(!blank($products))
                        ...
                        <div class="row" id="single-product">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="unit_price">{{ __('Prix Normal') }}</label> <span class="text-danger">*</span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="quantity">{{ __('Quantité') }}</label> <span class="text-danger">*</span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="discount_price">{{ __('Prix Yummy') }}</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button class="btn btn-primary" id="saveShopProduct" type="submit">{{ __('Enregistrer') }}</button>
                            </div>
                        </div>
                    </form>
                </div>

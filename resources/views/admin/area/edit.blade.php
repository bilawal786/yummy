				    	...
				    	<form action="{{ route('admin.area.update', $area) }}" method="POST">
						    ...
						    <div class="card-body">
									<div class="form-group">
														...
														<input type="text" name="cp" id="cp" class="form-control @error('cp') is-invalid @enderror" value="{{ old('cp', $area->cp) }}">
														@error('cp')
						        ...
						        <div class="form-group">
			                        ...
			                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $area->name) }}" disabled>
			                        @error('name')
				                        <div class="invalid-feedback">
				                          	{{ $message }}
				                        </div>

                    ...
                    <div class="card">
                        <form action="{{ route('admin.products.update', $product) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form">
                                    <div class="form-group col">
                                        <label for="discount_price">Prix initial</label> <span class="text-danger">*</span>
                                        <input id="discount_price" type="text" name="discount_price" class="form-control {{ $errors->has('discount_price') ? " is-invalid " : '' }}" value="{{ old('discount_price', $shopproduct->discount_price) }}">
                                    ...
                                    <div class="form-group col">
                                      <label for="inlineRadio1">Réduction Yummy</label> <span class="text-danger">*</span>
                                      <br>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="0.70" name="reduction" id="inlineRadio1">
                                        <label class="form-check-label" for="inlineRadio1">30%</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="0.50" name="reduction" id="inlineRadio2">
                                        <label class="form-check-label" for="inlineRadio2">50%</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="0.30" name="reduction" id="inlineRadio3">
                                    ...
                                    <div class="form-group col">
                                        <label for="unit_price">Quantité disponible</label> <span class="text-danger">*</span>
                                ...
                                <div class="form">
                                  <div class="form-group col">
                                      ...
                                      <input id="hdispoa" type="text" name="hdispoa" value="{{ old('hdispoa', $shopproduct->hdispoa) }}"
                                             class="timepicker form-control {{ $errors->has('hdispoa') ? " is-invalid " : '' }}">
                                  </div>
                                  <div class="form-group col">
                                      <label for="hdispob">Heure fin</label> <span class="text-danger">*</span>
                                      <input id="hdispob" type="text" name="hdispob" value="{{ old('hdispob', $shopproduct->hdispob) }}"
                            ...
                            <div class="card-footer ">
                                <button class="btn btn-primary btn-block mr-1" type="submit">{{ __('Mettre à jour') }}</button>
                            </div>
                        </form>
                    </div>
                </div>

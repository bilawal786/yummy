...
class OrderService
{
    ...
    public function order($data): object// done
    {
        ...
        if (!blank($data['items'])) {
            ...
            //dd($data['item']['quantity']);
                ...
                $orderLineItems = [
                    ...
                    'discounted_price'          => $data['item']['discounted_price'],
                    'item_total'                => ($data['item']['unit_price'] * $data['item']['quantity']),
                  /*  'shop_product_variation_id' => '0',
                    'options'                   => ['options'],*/
                  /*  'options_total'             => $optionTotal,*/
                    'created_at'                => date('Y-m-d H:i:s'),
                    'updated_at'                => date('Y-m-d H:i:s'),
                ];
                ShopProduct::where('product_id', $data['item']['product_id'])->decrement('quantity', $data['item']['quantity']);
        ...
        $order->misc = json_encode([
            'order_code' => 'CMD-' . MyString::code($orderId),

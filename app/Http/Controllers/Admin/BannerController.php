...
class BannerController extends BackendController
{
    ...
    public function update(BannerRequest $request, $id)
    {
        ...
        return redirect(route('admin.banner.index'))->withSuccess('Bannière mis à joour avec succès');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('admin.banner.index'))->withSuccess('Bannière supprimé avec succès');
    }

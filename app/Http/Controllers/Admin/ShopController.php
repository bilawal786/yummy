...
class ShopController extends BackendController
{
    ...
    public function store(ShopRequest $request)
    {
        ...
        $product->categories()->sync($request->get('categories'));
          ...
          $shopProduct->unit_price     = $request->get('unit_price') != null ? $request->get('unit_price') : 0;
    ...
    public function edit($id)
    {
      ...
      if(!blank($this->data['shop']->categories())){
        ...
        $this->data['shop_categories'] = "";
      }


        //$this->data['shop_categories'] = $shop->categories()->pluck('id')->toArray();
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($shopArray)->addColumn('action', function ($shop) {
              ...
              if($shop->vip !=0){
                ...
                return Str::limit($shop->user->name ?? null, 20).$vip;
